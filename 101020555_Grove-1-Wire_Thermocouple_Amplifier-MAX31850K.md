# Grove - 1-Wire Thermocouple Amplifier (MAX31850K) SKU：101020555
...
!!!Note
        **1-** We've offered two software examples, **simple** and **multiple**, the materials requirement above is for the  **multiple** example. If you want to test the **simple** example, then the Grove - I2C Hub is not necessary, and only one Grove - 1-Wire Thermocouple Amplifier will be enough. **2-** We use I2C Hub here not as a I^2^C interface, but just as a normal one-to-two transfer interface.
